...

{
  "image_generation": {
    ...
    "photo_style": {
      ...
      "lighting": "warm dim indoor lighting",
    ...
    "subject": {
      "pose": {
        "body": "sitting fully forward on the sofa",
        "legs": "one leg crossed over the other, facing the camera",
        "hands": "resting comfortably in lap",
        "head": "looking directly at the camera",
        "expression": "natural, confident, relaxed smile"
      },
      "appearance": {
        "hair": {
          "length": "long",
          "style": "loose with a side part",
          "accessory": "no hair accessories"
        },
        "makeup": {
      ...
      "clothing": {
        "top": {
          ...
          "print": "bold graphic text 'COZY' on the front"
        },
        "bottom": {
    ...
    "environment": {
      "setting": "clean, minimalist room",
      "elements": [
        "white leather sofa",
        "clean wooden floor",
        "minimalist background wall"
      ],
      "lighting_effects": [
        "warm dim glow",
