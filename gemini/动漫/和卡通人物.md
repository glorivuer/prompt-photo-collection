"image_generation": {
"quality": "photorealistic, 8k resolution, cinematic lighting, masterpiece",
"face": {
"preserve_original": true,
"reference_match": true
},
"subject": {
"description": "A stylish woman with a specific face, wearing an elegant white off-the-shoulder wedding dress with intricate lace textures.",
"pose": "The woman is leaning intimately against a massive, biologically realistic polar bear; they are standing together like old friends.",
"expression": "The woman has a mischievous, playful smirk; the bear has a soulful, intelligent, and joyful human-like expression."
},
"character_element": {
"name": "Realistic Coca-Cola Polar Bear",
"details": [
"Authentic polar bear anatomy with thick, creamy-white translucent fur",
"Individual hair strands visible, soft natural sheen on the coat",
"Moist black nose and realistic dark intelligent eyes with gentle crow's feet wrinkles",
"A weathered red knitted scarf around its neck with a vintage Coca-Cola logo embroidered on it",
"The bear is playfully mimicking the woman's pose, one paw resting gently near her shoulder"
]
},
"environment": {
"background": "Minimalist clean grey-blue studio backdrop with soft volumetric lighting and floor shadows",
"rendering_style": "National Geographic wildlife portrait meets high-fashion editorial, subsurface scattering on fur, shallow depth of field"
},
"negative_prompt": "3d render, cartoon, plush toy, stuffed animal, doll, plastic texture, low-res, CGI, animated, illustration, fake fur"
}
